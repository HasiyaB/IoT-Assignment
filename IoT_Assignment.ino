...
#define MQTT_DEVICEID "d:hwu.hb4009"
#define MQTT_USER "" // no need for authentication, for now
#define MQTT_TOKEN "" // no need for authentication, for now
#define MQTT_TOPIC "d:hwu.hb4009/evt/status/fmt/json"
#define MQTT_TOPIC_INTERVAL "d:hwu.hb4009/evt/interval/fmt/json"
#define MQTT_TOPIC_DISPLAY "d:hwu.hb4009/cmd/display/fmt/json"


// Add WiFi connection information
const char *ssid = "Hasiya";  // your network SSID (name)
const char *pass = "Babakano";  // your network password
